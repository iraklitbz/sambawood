        ...
        de: {
            ...
            home: {
                ...
                sectionOne: {
                     ...
                     text: 'Mit über 20 Jahren Erfahrung realisiert Sambawood professionelle Ladenbauprojekte und Projektkoordinationen europaweit. Als bewährter Subunternehmer für IKEA haben wir Projekte in mehr als 10 Ländern abgeschlossen – von Neubauten bis zu umfassenden Markthallen-Umbauten.',
                     text2: 'Unser internationales Team bringt Expertise in allen Projektphasen mit – von der Planung und Koordination bis zur finalen Montage. Ob Groß- oder Kleinprojekt: Wir arbeiten präzise und zuverlässig.',
                     text3: 'Bereit, Ihr nächstes Projekt zu besprechen?'
                 },
                 sectionTwo: {
                     boxOne: {
        ...
        en: {
            ...
            home: {
                ...
                sectionOne: {
                     ...
                     text: 'With over 20 years of experience, Sambawood delivers professional shopfitting and project coordination across Europe. As a trusted subcontractor for IKEA, we have completed projects in more than 10 countries — from new store builds to full market hall renovations.',
                     text2: 'Our international team brings hands-on expertise across every phase of a project: from planning and coordination to final installation. Whether large-scale or compact, we execute with precision and reliability.',
                     text3: 'Ready to discuss your next project?'
                 },
                 sectionTwo: {
                     boxOne: {
